...
def try_methods_and_functions():
    ...
    """
    rick = rg.SimpleTurtle()
    rick.pen = rg.Pen('blue', 5)
    rick.backward(150)
    rick.speed = 1
    draw_many_squares(rick, 2, 100, 30)
    rick.speed = 5
    rick.pen = rg.Pen('red', 5)
    draw_many_squares(rick, 10, 50, 15)
    rick.speed = 100
    rick.pen = rg.Pen('red', 35)
    draw_many_squares(rick, 8, 300, 60)
    rick.pen = rg.Pen('black', 3)
    rick.backward(200)
    rick.draw_circle(30)
    rick.draw_square(50)
